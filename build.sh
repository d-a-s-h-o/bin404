...
build_binary_rice "binaries/""$version""/bin404-server-v""$version""_"

cd bin404-genkey
build_binary "../binaries/""$version""/bin404-genkey-v""$version""_"
cd ..

cd bin404-cleanup
build_binary "../binaries/""$version""/bin404-cleanup-v""$version""_"
cd ..
