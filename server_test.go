...
func TestAddHeader(t *testing.T) {
	Config.addHeaders = []string{"bin404-Test: It works!"}
	...
	if w.Header().Get("bin404-Test") != "It works!" {
		t.Fatal("Header 'bin404-Test: It works!' not found in index response")
	}
}
...
func TestPostCodeUploadWhitelistedHeader(t *testing.T) {
	...
	req.PostForm = form
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("bin404-Expiry", "0")
...
func TestPostJSONUploadMaxExpiry(t *testing.T) {
	...
	for _, expiry := range testExpiries {
		...
		req.Header.Set("Content-Type", mw.FormDataContentType())
		req.Header.Set("Accept", "application/json")
		req.Header.Set("bin404-Expiry", expiry)
		if err != nil {
			t.Fatal(err)
		}
...
func TestPutRandomizedUpload(t *testing.T) {
	...
	req.Header.Set("bin404-Randomize", "yes")
...
func TestPutForceRandomUpload(t *testing.T) {
	...
	req.Header.Set("bin404-Randomize", "no")
...
func TestPutExpireJSONUpload(t *testing.T) {
	...
	req.Header.Set("Accept", "application/json")
	req.Header.Set("bin404-Expiry", "600")
...
func TestPutAndDelete(t *testing.T) {
	...
	req.Header.Set("bin404-Delete-Key", myjson.Delete_Key)
	mux.ServeHTTP(w, req)
...
func TestPutAndOverwrite(t *testing.T) {
	...
	req.Header.Set("bin4040404-Delete-Key", myjson.Delete_Key)
	mux.ServeHTTP(w, req)
...
func TestPutAndSpecificDelete(t *testing.T) {
	...
	req.Header.Set("Accept", "application/json")
	req.Header.Set("bin404-Delete-Key", "supersecret")
